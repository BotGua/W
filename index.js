...
const config = {
    A187: '🖤Akb4r™🖤',
    instagram: 'https://instagram.com/kamaadoo_tanjiroo',
    nomer: 'wa.me/+6281368965962',
    aktif: '24 JAM',
    youtube: 'Belum buat',
    whatsapp: 'https://chat.whatsapp.com/K4vJLX34mvqIDS7cd05Gfi',
...
// client.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log(`${time}: Bot by ig:@kamaadoo_,tanjiroo`)

client.on('message-status-update', json => {
   const participant = json.participant ? ' (' + json.participant + ')' : ''
   console.log(`[ ${time} ] => bot by ig:@kamaadoo_tanjiroo`)
})
